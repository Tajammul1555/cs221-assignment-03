<?php
    if( isset( $_POST['Save_btn'] ) ):
        ...
        $query = "INSERT INTO cv1 ( First_Name, Last_Name, Adres, Phone, Email, Date1, Job_Title1, Description1, Date2, Job_Title2, Description2, Month1, Degree_Title1, Description3, Month2, Degree_Title2, Description4, Skill_One, Skill_Two, Skill_Three, Skill_Four, Skill_Five, Activities )
    ...
    <form action="" method="post">
        <div class="container bg-dark text-white">
            <div class="form-inline row justify-content-center align-items-center">
                ...
                <input type="text" name="lastName_box" class="form-control" placeholder="Enter Last Namee here">
            </div>
            <div class="form-inline row justify-content-center align-items-center">
        ...
        <div class="container">
            <div class="btn-group float-right mt-2">
                <br><button key="isset" name="Save_btn" class="btn btn-outline-primary">Submit</button>
                <br><button class="btn btn-outline-primary">Generate</button>
            </div>
        </div>
    </form>
